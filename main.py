        ...
        completion = client.chat.completions.create(
            ...
            messages=[
            {
                ...
                "content": (
                    ...
                    "4. 답변은 한국어로 작성하세요."
                    "5. Telegram 메시지 형식에 맞게 마크다운 문법을 사용하세요."
                    "6. 답변은 아래의 형식을 엄격히 따르세요:\n"
                    "- 주가 영향: [0점(악재)부터 10점(호재) 사이의 점수를 특수문자 기호(빈 네모(□), 꽉 찬 네모(■))로 표시하세요. 모두 합쳐서 10개이고, 점수에 따라 왼쪽부터 꽉 찬 네모를 채웁니다.] - 이유\n"
                    "- 핵심 요약:\n  • 요약1\n  • 요약2\n  • 요약3\n"
                    "- 유의사항: 내용\n"
                )
            },
